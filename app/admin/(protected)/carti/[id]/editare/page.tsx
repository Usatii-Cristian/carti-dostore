...
export default async function EditBookPage({ params }: PageProps) {
  ...
  const [book, categories] = await Promise.all([getBookForEdit(id), getAllCategories()]);
  ...
  return (
    <div>
      ...
      <BookForm action={updateBook.bind(null, id)} categories={categories} initialBook={book} />
    </div>
  );
}
